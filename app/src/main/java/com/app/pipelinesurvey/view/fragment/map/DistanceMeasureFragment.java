...
public class DistanceMeasureFragment extends Fragment implements View.OnClickListener, MeasureListener, MeasureStateListener {
    ...
    */
    ...
    public void lengthMeasured(double v, Point point) {
        LogUtills.i("测量长度 = ",String.valueOf(v));
