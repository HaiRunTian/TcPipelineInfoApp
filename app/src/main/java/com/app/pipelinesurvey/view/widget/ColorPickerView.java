...
public class ColorPickerView extends View {
    ...
    private void init() {
        ...
        //灰度饱和度指示器的半径
        mSVTrackerRadius *= mDensity;
        //色相指示器高度
        mHTrackerHeight *= mDensity;
        //H、SV矩形与父布局的边距
        mRectOffset *= mDensity;
        //H矩形的宽度
        mHuePanelWidth *= mDensity;
        //H、SV矩形间的间距
        mPanelSpacing *= mDensity;
        //当mode为MeasureSpec.UNSPECIFIED时的首选高度
        mPreferredHeight *= mDensity;
        //当mode为MeasureSpec.UNSPECIFIED时的首选宽度
        mPreferredWidth *= mDensity;
        //计算所需位移
