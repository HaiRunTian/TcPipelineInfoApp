...
//        initAllData();
    ...
    private void initCountForDate() {
        ...
        //查询当天已测量收点管线的总长度
        Recordset recordSet = DataHandlerObserver.ins().QueryRecordsetBySql("measureStart = '1' and measureEnd = '1' and measureDate = '" +
                m_tvDate.getText().toString() + "'", false, false);
    ...
    public static void initAllData() {
        ...
        LogUtills.i("measureLength = ", String.valueOf(checkLength));

        //显示
        m_waitCheck.setText(_meaPointCount - _checkPoint + "");
        m_tvAllPoint.setText(_meaPointCount+"");
        DecimalFormat df = new DecimalFormat("0.00");
