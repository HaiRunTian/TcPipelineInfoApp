...
public class MeasureAreaFragment extends Fragment implements View.OnClickListener, MeasureListener, MeasureStateListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View _view = inflater.inflate(R.layout.fragment_area_measurement, container, false);
