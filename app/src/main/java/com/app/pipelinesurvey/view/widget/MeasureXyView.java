...
import com.app.pipelinesurvey.utils.UiUtil;

/**
 * 测量坐标时的自定义view
 *
 * @author HaiRun
 * @time 2019/7/16.11:07
 */
@SuppressLint("AppCompatCustomView")
public class MeasureXyView extends ImageView {
    /**
     * 测量宽度 MeasureXyView
     */
    private int width;
     ...
     * 初始化属性
     */
    public MeasureXyView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        maxHeight = UiUtil.getMaxHeight(context) - getStatusBarHeight();
