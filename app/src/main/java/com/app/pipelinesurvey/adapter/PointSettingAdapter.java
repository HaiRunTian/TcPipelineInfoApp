 ...
 */
public class PointSettingAdapter extends BaseExpandableListAdapter {
    private Context context;
    private List<FatherPoint> list;
    private LayoutInflater inflater;

    public PointSettingAdapter(Context context, List<FatherPoint> list) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        childViewHolder.checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                DatabaseHelpler.getInstance().update(SQLConfig.TABLE_NAME_POINT_SETTING, contentValues, "prj_name = ? and pipetype = ?",
