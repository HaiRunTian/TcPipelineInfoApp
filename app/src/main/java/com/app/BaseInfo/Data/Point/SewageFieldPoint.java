...
public class SewageFieldPoint extends RainFieldPoint {
    public SewageFieldPoint() {
        type = POINTTYPE.Type_Sewage_W;
        datasetName = SuperMapConfig.Layer_Sewage;
        Init();
    }

    public SewageFieldPoint(String name) {
        type = POINTTYPE.Type_Sewage_W;
        datasetName = name;
        Init();
    }
...
//        String[] _objs = new String[] { "窨井", "检查井", "沉沙井", "接户井", "污水篦", "化粪池", "立管点", "探测点" };
//        int[] _ids = new int[] {409,409,409,409,410,411,415,415};
        ...
        Size2D _size2D5 = new Size2D(3.0, 7.0);//预留口、非普查
