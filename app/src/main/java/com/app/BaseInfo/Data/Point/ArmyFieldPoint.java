...
public class ArmyFieldPoint extends BaseFieldPInfos {
    public ArmyFieldPoint(){
        type = POINTTYPE.Type_Army_B;
        datasetName = SuperMapConfig.Layer_Army;
        Init();
    }

    public ArmyFieldPoint(String name){
...
//        int[] _ids = new int[] {         436,     419,      420,      421,      438,     437,       437,       436,    433,     428};
        ...
        String _color = "#336600";

        //规程管点符号 大小 * 2.5
        Size2D _size2D1 = new Size2D(2.5, 2.5);//探测点、拐点、三通、四通、多通、一般管线点、井边点、井内点、入户
        Size2D _size2D2 = new Size2D(2.5, 4.0);//变径
        Size2D _size2D3 = new Size2D(2.5, 4.5);//出地 上杆
        Size2D _size2D4 = new Size2D(4.0, 6.5);//阀门
        Size2D _size2D5 = new Size2D(4.0, 6.0);//预留口、非普查
        Size2D _size2D6 = new Size2D(4.0, 2.5);//雨水篦、污水篦、溢流井、出气井
        Size2D _size2D7 = new Size2D(4.0, 4.0);//化粪池、净化池、进水口、出水口、污水井、雨水井、闸门井、跌水井、通风井、冲洗井、水封井 人孔井
        Size2D _size2D8 = new Size2D(6.5, 4.0);//排水泵、雨水篦
