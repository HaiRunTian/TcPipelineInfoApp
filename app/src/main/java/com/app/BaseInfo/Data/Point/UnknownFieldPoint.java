...
public class UnknownFieldPoint extends BaseFieldPInfos {

    public UnknownFieldPoint(){
        type = POINTTYPE.Type_Unknown_N;
        datasetName = SuperMapConfig.Layer_Unknown;
        Init();
    }

    public UnknownFieldPoint(String name){
        type = POINTTYPE.Type_Unknown_N;
        datasetName = name;
        Init();
    }
...
//        int[] _ids = new int[] {401,399,402,402,400,403,408};
        ...
        Size2D[] _size2Ds = new Size2D[]{_size2D7,_size2D4,_size2D7,_size2D7,_size2D7,_size2D7,_size2D7,_size2D5,_size2D2,_size2D5,
