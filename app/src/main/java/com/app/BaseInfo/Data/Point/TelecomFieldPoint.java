...
/**
 * Created by Los on 2018-06-26 11:01.
 * 电信
 */

public class TelecomFieldPoint extends BaseFieldPInfos {
    public TelecomFieldPoint() {
        type = POINTTYPE.Type_Telecom_D;
        datasetName = SuperMapConfig.Layer_Telecom;
        Init();
    }

    public TelecomFieldPoint(String name) {
        type = POINTTYPE.Type_Telecom_D;
        datasetName = name;
        Init();
    }
